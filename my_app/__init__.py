...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://doadmin:LVOiu7tykB9pIcxz@db-postgresql-nyc3-86227-do-user-9807415-0.b.db.ondigitalocean.com:25060/defaultdb?sslmode=require'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['UPLOAD_FOLDER'] = os.path.realpath('.') +'/my_app/static/uploads'
app.config['WTF_CSRF_SECRET_KEY']  = 'random key for form'
app.config['LOG_FILE'] = 'application.log'
app.config['AWS_ACCESS_KEY'] = 'AKIAQ33NPU6TF2PYLNHZ'
app.config['AWS_SECRET_KEY'] = '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'
